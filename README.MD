Here's your updated `README.md` reflecting the recent switch to **CatBoostClassifier**, updated performance metrics, and refined language for clarity and accuracy:
